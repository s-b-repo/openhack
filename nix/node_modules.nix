...
let
  packageJson = lib.pipe ../packages/openhack-cli/package.json [
    builtins.readFile
    builtins.fromJSON
  ];
  ...
  src = lib.fileset.toSource {
    ...
    fileset = lib.fileset.intersection (lib.fileset.fromSource (lib.sources.cleanSource ../.)) (
      lib.fileset.unions [
        ...
        ../.github/TEAM_MEMBERS # required by @openhack-ai/script
      ]
    );
  };
