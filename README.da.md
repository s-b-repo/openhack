...
brew install anomalyco/tap/openhack # macOS og Linux (anbefalet, altid up to date)
brew install openhack              # macOS og Linux (officiel brew formula, opdateres sjældnere)
...
OpenHack findes også som desktop-app. Download direkte fra [releases-siden](https://github.com/anomalyco/openhack/releases) eller [cybersec.org.za/download](https://cybersec.org.za/download).
...
1. `$OPENHACK_INSTALL_DIR` - Tilpasset installationsmappe
...
OpenHack har to indbyggede agents, som du kan skifte mellem med `Tab`-tasten.
...
Læs mere om [agents](https://cybersec.org.za/docs/agents).

### Dokumentation

For mere info om konfiguration af OpenHack, [**se vores docs**](https://cybersec.org.za/docs).

### Bidrag

Hvis du vil bidrage til OpenHack, så læs vores [contributing docs](./CONTRIBUTING.md) før du sender en pull request.

### Bygget på OpenHack

Hvis du arbejder på et projekt der er relateret til OpenHack og bruger "openhack" som en del af navnet; f.eks. "openhack-dashboard" eller "openhack-mobile", så tilføj en note i din README, der tydeliggør at projektet ikke er bygget af OpenHack-teamet og ikke er tilknyttet os på nogen måde.

---

**Bliv en del af vores community** [Discord](https://discord.gg/openhack) | [X.com](https://x.com/openhack)
