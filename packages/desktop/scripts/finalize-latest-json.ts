...
const releaseId = process.env.OPENHACK_RELEASE
if (!releaseId) throw new Error("OPENHACK_RELEASE is required")

const version = process.env.OPENHACK_VERSION
if (!version) throw new Error("OPENHACK_VERSION is required")
...
const macxTarGz = "openhack-desktop-mac-x64.app.tar.gz"
const macaTarGz = "openhack-desktop-mac-arm64.app.tar.gz"
