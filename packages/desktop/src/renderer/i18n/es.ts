export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de OpenHack",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de OpenHack. ¿Quieres instalarla y reiniciar?",
