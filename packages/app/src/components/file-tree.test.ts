...
beforeAll(async () => {
  ...
  mock.module("@openhack-ai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@openhack-ai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@openhack-ai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@openhack-ai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
