...
const PROVIDER_NOTES = [
  { match: (id: string) => id === "openhack", key: "dialog.provider.openhack.note" },
  { match: (id: string) => id === "openhack-go", key: "dialog.provider.openhackGo.tagline" },
...
export const SettingsProvidersV2: Component = () => {
  ...
  const connected = createMemo(() => {
    return providers
      .connected()
      .filter((p) => p.id !== "openhack" || Object.values(p.models).find((m) => m.cost?.input))
  })
                  ...
                  <div class="settings-v2-provider-lead">
                    ...
                    <div class="settings-v2-provider-copy">
                      <div class="settings-v2-provider-main">
                        ...
                        <Show when={item.id === "openhack" || item.id === "openhack-go"}>
