...
export const loadMcpQuery = (scope: ServerScope, directory: string, sdk: OpenhackClient) =>
  queryOptions({
    queryKey: [scope, directory, "mcp"] as const,
    queryFn: () => sdk.mcp.status().then((r) => r.data ?? {}),
  })

export const loadMcpResourcesQuery = (scope: ServerScope, directory: string, sdk: OpenhackClient) =>
...
export const loadLspQuery = (scope: ServerScope, directory: string, sdk: OpenhackClient) =>
  queryOptions({
...
function makeQueryOptionsApi(
  ...
  sdkFor: (dir: PathKey) => OpenhackClient,
) {
  return {
...
export function createServerSyncContextInner(serverSDK: ServerSDK) {
  ...
  const sdkCache = new Map<string, OpenhackClient>()
