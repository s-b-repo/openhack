...
import type { Config, OpenhackClient, Project, Session } from "@openhack-ai/sdk/v2/client"
import type { NormalizedProviderListResponse } from "@openhack-ai/session-ui/context"
...
describe("query keys", () => {
  test("partitions identical directories by server scope", () => {
    const client = {} as OpenhackClient
