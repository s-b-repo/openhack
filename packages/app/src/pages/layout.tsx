...
import { Session } from "@openhack-ai/sdk/v2/client"
...
import { toaster } from "@openhack-ai/ui/toast"
...
import { useTheme, type ColorScheme } from "@openhack-ai/ui/theme/context"
...
export default function LegacyLayout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openLink("https://cybersec.org.za/desktop-feedback")}
      renderPanel={() =>
