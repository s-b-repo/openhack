...
import { Logo } from "@openhack-ai/ui/logo"
import { Spinner } from "@openhack-ai/ui/spinner"
import { ScrollView } from "@openhack-ai/ui/scroll-view"
import { ProjectAvatar } from "@openhack-ai/ui/v2/project-avatar-v2"
...
import { base64Encode } from "@openhack-ai/core/util/encode"
...
import { useMarked } from "@openhack-ai/ui/context/marked"
import { preloadMarkdown } from "@openhack-ai/session-ui/markdown-cache"
    ...
    <div class="rounded-[10px] shadow-[var(--v2-elevation-raised)] m-2 min-h-0 lg:overflow-hidden bg-v2-background-bg-base self-stretch flex-1">
      <div class="mx-auto grid h-full w-full max-w-[1080px] grid-rows-[auto_minmax(0,1fr)_auto] gap-4 px-3 lg:grid-cols-[280px_minmax(0,720px)] lg:grid-rows-1 lg:gap-8 lg:px-6">
        <HomeProjectColumn
          ...
          openHelp={() => platform.openLink("https://cybersec.org.za/desktop-feedback")}
          language={language}
        />
