...
export const DESKTOP_MENU: DesktopMenu[] = [
  ...
  },
  {
    ...
    label: "Help",
    items: [
      { type: "item", label: "OpenHack Documentation", href: "https://cybersec.org.za/docs" },
      { type: "item", label: "Support Forum", href: "https://discord.com/invite/openhack" },
      { type: "item", label: "Export Logs...", command: "logs.export" },
      { type: "separator" },
      {
        type: "item",
        label: "Share Feedback",
        href: "https://github.com/anomalyco/openhack/issues/new?template=feature_request.yml",
      },
      {
        type: "item",
        label: "Report a Bug",
        href: "https://github.com/anomalyco/openhack/issues/new?template=bug_report.yml",
      },
    ],
  },
]
