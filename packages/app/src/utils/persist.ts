...
const GLOBAL_STORAGE = "openhack.global.dat"
const WINDOW_STORAGE = "openhack.window"
const LOCAL_PREFIX = "openhack."
...
function workspaceStorage(dir: string) {
  ...
  return `openhack.workspace.${head}.${sum}.dat`
}
...
function draftStorage(draftID: string) {
  ...
  return `openhack.draft.${head}.${sum}.dat`
}
