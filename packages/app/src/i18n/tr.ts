...
export const dict = {
  ...
  "dialog.provider.openhack.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.openhack.tagline": "Güvenilir optimize edilmiş modeller",
  "dialog.provider.openhackGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "OpenHack tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve OpenHack'da {{provider}} modellerini kullanmak için {{provider}} API anahtarınızı girin.",
  ...
  "provider.connect.openhackZen.line1":
    "OpenHack Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.openhackZen.visit.prefix": "",
  "provider.connect.openhackZen.visit.link": "cybersec.org.za/zen",
  "provider.connect.openhackZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  "provider.connect.oauth.code.visit.prefix":
    "Hesabınızı bağlamak ve OpenHack'da {{provider}} modellerini kullanmak için ",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak OpenHack'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler openhack.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi OpenHack sunucusuna bağlanacağını değiştirin.",
  ...
  "toast.update.description": "OpenHack'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı OpenHack ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (openhack.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: OpenHack henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "OpenHack ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "OpenHack Masaüstü",
  ...
  "settings.desktop.wsl.description": "OpenHack sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "OpenHack'un görünüm dilini değiştirin",
  "settings.general.row.appearance.title": "Görünüm",
  "settings.general.row.appearance.description": "OpenHack'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "OpenHack'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "OpenHack'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "OpenHack başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "OpenHack'un en son sürümünü kullanıyorsunuz.",
