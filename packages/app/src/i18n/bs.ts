export const dict = {
  ...
  "dialog.provider.openhack.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.openhack.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.openhackGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje OpenHack",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u OpenHack-u.",
  ...
  "provider.connect.openhackZen.line1":
    "OpenHack Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.openhackZen.visit.prefix": "Posjeti ",
  "provider.connect.openhackZen.visit.link": "cybersec.org.za/zen",
  "provider.connect.openhackZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u OpenHack-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u OpenHack-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u openhack.json",
  ...
  "dialog.server.description": "Promijeni na koji se OpenHack server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija OpenHack-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku OpenHack timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (openhack.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: OpenHack još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "OpenHack uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni OpenHack server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u OpenHack-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako OpenHack izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li OpenHack prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu OpenHack-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se OpenHack pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju OpenHack-a.",
