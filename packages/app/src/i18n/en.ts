export const dict = {
  ...
  "dialog.provider.openhack.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.openhack.tagline": "Reliable optimized models",
  "dialog.provider.openhackGo.tagline": "Low cost subscription for everyone",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by OpenHack",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in OpenHack.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.openhackZen.line1":
    "OpenHack Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.openhackZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.openhackZen.visit.prefix": "Visit ",
  "provider.connect.openhackZen.visit.link": "cybersec.org.za/zen",
  "provider.connect.openhackZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in OpenHack.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in OpenHack.",
  ...
  "dialog.plugins.empty": "Plugins configured in openhack.json",
  ...
  "dialog.server.description": "Switch which OpenHack server this app connects to.",
  ...
  "wsl.onboarding.step.openhack": "OpenHack",
  ...
  "wsl.onboarding.checkingOpenhack": "Checking OpenHack...",
  "wsl.onboarding.checkingOpenhackIn": "Checking OpenHack in {{distro}}...",
  "wsl.onboarding.updatingOpenhack": "Updating OpenHack...",
  "wsl.onboarding.updatingOpenhackIn": "Updating OpenHack in {{distro}}...",
  "wsl.onboarding.updateOpenhackIn": "Update OpenHack in {{distro}}.",
  "wsl.onboarding.updateOpenhack": "Update OpenHack",
  "wsl.onboarding.openhackReadyIn": "OpenHack is ready in {{distro}}.",
  "wsl.onboarding.openhackReady": "OpenHack is ready.",
  "wsl.onboarding.installOpenhackIn": "Install OpenHack in {{distro}}.",
  "wsl.onboarding.installOpenhack": "Install OpenHack",
  ...
  "wsl.onboarding.distroStatus.openhackMissing": "OpenHack not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before OpenHack can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "OpenHack could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen OpenHack.",
  ...
  "toast.update.description": "A new version of OpenHack ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the OpenHack team",
  ...
  "error.chain.checkConfig": "Check your config (openhack.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, OpenHack does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "OpenHack includes free models so you can start immediately.",
  ...
  "app.name.desktop": "OpenHack Desktop",
  ...
  "settings.desktop.wsl.description": "Run the OpenHack server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for OpenHack",
  ...
  "settings.general.row.appearance.description": "Customise how OpenHack looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether OpenHack follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how OpenHack is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when OpenHack launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of OpenHack.",
