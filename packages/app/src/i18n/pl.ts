export const dict = {
  ...
  "dialog.provider.openhack.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.openhack.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.openhackGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez OpenHack",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w OpenHack.",
  ...
  "provider.connect.openhackZen.line1":
    "OpenHack Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.openhackZen.visit.prefix": "Odwiedź ",
  "provider.connect.openhackZen.visit.link": "cybersec.org.za/zen",
  "provider.connect.openhackZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w OpenHack.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w OpenHack.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w openhack.json",
  ...
  "dialog.server.description": "Przełącz serwer OpenHack, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja OpenHack ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu OpenHack",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (openhack.json) nazwy dostawców/modeli",
  ...
  "sidebar.gettingStarted.line1": "OpenHack zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla OpenHack",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd OpenHack na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy OpenHack ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw OpenHack.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania OpenHack",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji OpenHack.",
