export const dict = {
  ...
  "dialog.provider.openhack.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.openhack.tagline": "Pålidelige optimerede modeller",
  "dialog.provider.openhackGo.tagline": "Billigt abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af OpenHack",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i OpenHack.",
  ...
  "provider.connect.openhackZen.line1":
    "OpenHack Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  "provider.connect.openhackZen.line2":
    "Med en enkelt API-nøgle får du adgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.openhackZen.visit.prefix": "Besøg ",
  "provider.connect.openhackZen.visit.link": "cybersec.org.za/zen",
  "provider.connect.openhackZen.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.oauth.code.visit.prefix": "Besøg ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i OpenHack.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i OpenHack.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i openhack.json",
  ...
  "dialog.server.description": "Skift hvilken OpenHack-server denne app forbinder til.",
  ...
  "toast.update.description": "En ny version af OpenHack ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til OpenHack-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (openhack.json) udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, OpenHack understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "OpenHack inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør OpenHack-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for OpenHack",
  "settings.general.row.appearance.title": "Udseende",
  "settings.general.row.appearance.description": "Tilpas hvordan OpenHack ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om OpenHack følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan OpenHack er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når OpenHack starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af OpenHack.",
