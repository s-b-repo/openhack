...
import { AgentV2 } from "@openhack-ai/core/agent"
import { ModelV2 } from "@openhack-ai/core/model"
import { SessionV2 } from "@openhack-ai/core/session"
import { Agent } from "@openhack-ai/schema/agent"
import { Location } from "@openhack-ai/schema/location"
import { Model } from "@openhack-ai/schema/model"
import { AgentAttachment, FileAttachment, Prompt, Source } from "@openhack-ai/schema/prompt"
import { Provider } from "@openhack-ai/schema/provider"
import { Project } from "@openhack-ai/schema/project"
import { ProjectDirectories } from "@openhack-ai/schema/project-directories"
import { PermissionV1 } from "@openhack-ai/schema/permission-v1"
import { Session } from "@openhack-ai/schema/session"
import { SessionInput } from "@openhack-ai/schema/session-input"
import { SessionMessage } from "@openhack-ai/schema/session-message"
import { Workspace } from "@openhack-ai/schema/workspace"
import { Command } from "@openhack-ai/schema/command"
import { Connection } from "@openhack-ai/schema/connection"
import { Credential } from "@openhack-ai/schema/credential"
import { FileSystem } from "@openhack-ai/schema/filesystem"
import { Integration } from "@openhack-ai/schema/integration"
import { LLM } from "@openhack-ai/schema/llm"
import { Permission } from "@openhack-ai/schema/permission"
import { Plugin } from "@openhack-ai/schema/plugin"
import { Pty } from "@openhack-ai/schema/pty"
import { Reference } from "@openhack-ai/schema/reference"
import { SessionTodo } from "@openhack-ai/schema/session-todo"
import { Skill } from "@openhack-ai/schema/skill"
import { AbsolutePath, DateTimeUtcFromMillis, optional, statics } from "@openhack-ai/schema/schema"
import { ProviderV2 } from "@openhack-ai/core/provider"
import { PluginV2 } from "@openhack-ai/core/plugin"
...
test("Core reuses the canonical shared schemas", async () => {
  const [
    ...
    import("@openhack-ai/core/command"),
    import("@openhack-ai/core/integration/connection"),
    import("@openhack-ai/core/credential"),
    import("@openhack-ai/core/filesystem"),
    import("@openhack-ai/core/integration"),
    import("@openhack-ai/core/location"),
    import("@openhack-ai/llm"),
    import("@openhack-ai/core/permission"),
    import("@openhack-ai/core/v1/permission"),
    import("@openhack-ai/core/project/copy"),
    import("@openhack-ai/core/pty"),
    import("@openhack-ai/core/project/schema"),
    import("@openhack-ai/core/reference"),
    import("@openhack-ai/core/session/input"),
    import("@openhack-ai/core/session/message"),
    import("@openhack-ai/core/session/todo"),
    import("@openhack-ai/core/session/prompt"),
    import("@openhack-ai/core/skill"),
    import("@openhack-ai/core/v2-schema"),
    import("@openhack-ai/core/schema"),
    import("@openhack-ai/core/workspace"),
  ])
