...
import { ProviderPlugins } from "@openhack-ai/core/plugin/provider"
import { ZenmuxPlugin } from "@openhack-ai/core/plugin/provider/zenmux"
...
describe("ZenmuxPlugin", () => {
  ...
  it.effect("applies the exact legacy Zenmux headers", () =>
    Effect.gen(function* () {
      ...
      expect(result.request.headers).toEqual({ "HTTP-Referer": "https://cybersec.org.za/", "X-Title": "openhack" })
