import type { PluginContext } from "@openhack-ai/plugin/v2/effect"
...
import type { IntegrationEnvMethod, IntegrationKeyMethod, IntegrationOAuthMethod } from "@openhack-ai/sdk/v2/types"
