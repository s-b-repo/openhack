import { convertToOpenAICompatibleChatMessages as convertToCopilotMessages } from "@openhack-ai/core/github-copilot/chat/convert-to-openai-compatible-chat-messages"
