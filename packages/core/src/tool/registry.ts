...
import { ToolOutput, type ToolCall, type ToolDefinition, type ToolResultValue } from "@openhack-ai/llm"
...
export class Service extends Context.Service<Service, Interface>()("@openhack/v2/ToolRegistry") {}
