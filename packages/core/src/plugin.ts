...
import type { Plugin as PluginRuntime } from "@openhack-ai/plugin/v2/effect"
...
export class Service extends Context.Service<Service, Interface>()("@openhack/v2/Plugin") {}
