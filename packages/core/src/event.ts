...
import type { Data, Definition, Payload } from "@openhack-ai/schema/event"
...
import { Durable } from "@openhack-ai/schema/durable-event-manifest"

export const ID = Event.ID
export type ID = import("@openhack-ai/schema/event").ID
export type { Data, Definition, Payload } from "@openhack-ai/schema/event"
...
export class Service extends Context.Service<Service, Interface>()("@openhack/Event") {}
