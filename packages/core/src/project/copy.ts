...
import { Event } from "@openhack-ai/schema/project-directories"
import { ProjectCopy } from "@openhack-ai/schema/project-copy"
...
export class Service extends Context.Service<Service, Interface>()("@openhack/ProjectCopy") {}
