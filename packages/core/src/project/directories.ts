...
import type { EffectDrizzleSqlite } from "@openhack-ai/effect-drizzle-sqlite"
...
export class Service extends Context.Service<Service, Interface>()("@openhack/ProjectDirectories") {}
