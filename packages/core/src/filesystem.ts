...
import { Entry, FileSystem, FindInput, Match } from "@openhack-ai/schema/filesystem"
export { Entry, Match, Submatch } from "@openhack-ai/schema/filesystem"
...
export class Service extends Context.Service<Service, Interface>()("@openhack/v2/FileSystem") {}
