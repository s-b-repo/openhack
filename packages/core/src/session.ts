...
import { ListAnchor } from "@openhack-ai/schema/session"
...
import { SessionDurable } from "@openhack-ai/schema/durable-event-manifest"
...
export class Service extends Context.Service<Service, Interface>()("@openhack/v2/Session") {}
