...
export class Service extends Context.Service<Service, Interface>()("@openhack/v2/FileSystem/Search") {}
...
const layer = Layer.unwrap(Effect.sync(() => (Flag.OPENHACK_DISABLE_FFF || !Fff.available() ? ripgrepLayer : fffLayer)))
