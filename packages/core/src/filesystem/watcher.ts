...
import { FileSystemWatcher } from "@openhack-ai/schema/filesystem-watcher"
...
declare const OPENHACK_LIBC: string | undefined
...
const watcher = lazy((): typeof import("@parcel/watcher") | undefined => {
  try {
    const libc = typeof OPENHACK_LIBC === "undefined" ? undefined : OPENHACK_LIBC
...
export class Service extends Context.Service<Service, Interface>()("@openhack/v2/FileWatcher") {}

const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (yield* Flag.OPENHACK_EXPERIMENTAL_DISABLE_FILEWATCHER) return Service.of({})
    ...
    if (yield* Flag.OPENHACK_EXPERIMENTAL_FILEWATCHER) {
