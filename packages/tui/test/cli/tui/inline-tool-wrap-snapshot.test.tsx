...
const tools: readonly ToolFixture[] = [
  {
    icon: "✱",
    label:
      'Grep "OPENHACK.*DB|database|sqlite|drizzle|dev.*db|data.*dir|xdg|APPDATA" in packages/openhack-cli/src (151 matches)',
  },
  {
    icon: "✱",
    label: 'Glob "**/*db*" in packages/openhack-cli (6 matches)',
  },
  {
    icon: "→",
    label: "Read packages/openhack-cli/src/storage/db.ts [offset=1, limit=130]",
  },
  {
    icon: "→",
    label: "Read packages/openhack-cli/src/index.ts [offset=1, limit=100]",
    error: "No LSP server available for this file type.",
  },
  {
    icon: "✱",
    label:
      'Grep "export const OPENHACK_DB|OPENHACK_DB|OPENHACK_DEV|Global\\.Path\\.data|data =" in packages/openhack-cli/src (115 matches)',
  },
] as const
