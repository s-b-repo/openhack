...
import { useBindings, useOpenhackModeStack } from "../keymap"
...
function init() {
  ...
  const renderer = useRenderer()
  const modeStack = useOpenhackModeStack()
  ...
  return (
    <ctx.Provider value={value}>
      ...
      <box
        ...
        onMouseUp={!Flag.OPENHACK_EXPERIMENTAL_DISABLE_COPY_ON_SELECT ? copySelection : undefined}
      >
