...
import defaultSoundPath from "@openhack-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@openhack-ai/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@openhack-ai/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@openhack-ai/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@openhack-ai/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@openhack-ai/ui/audio/yup-01.mp3" with { type: "file" }
...
const DEFAULT_TITLE = "openhack"
const DEFAULT_PACK_ID = "openhack.default"
const KV_SOUND_PACK = "attention_sound_pack"
const TITLE_LIMIT = 80
const MESSAGE_LIMIT = 240
const BUILTIN_PACK: RegisteredSoundPack = {
  id: DEFAULT_PACK_ID,
  name: "OpenHack Default",
  builtin: true,
  sounds: {
