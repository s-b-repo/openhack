...
import type { AssistantMessage, FilePart, UserMessage } from "@openhack-ai/sdk/v2"
...
import { OPENHACK_BASE_MODE, useBindings, useCommandShortcut, useLeaderActive, useOpenhackKeymap } from "../../keymap"
  ...
  const promptCommands = createMemo(() =>
    [
      ...
      },
      {
        ...
        name: "workspace.set",
        category: "Session",
        enabled: Flag.OPENHACK_EXPERIMENTAL_WORKSPACES,
        slashName: "warp",
        run: () => {
          workspace.open()
        },
