...
import { compile, emitEffectImported, emitPromise, write } from "@openhack-ai/httpapi-codegen"
    ...
    [
      write(
        emitPromise(contract, {
          outputTypes: {
            "events.subscribe": {
              name: "OpenHackEventEncoded",
              import: 'import type { OpenHackEventEncoded } from "@openhack-ai/protocol/groups/event"',
            },
          },
        }),
