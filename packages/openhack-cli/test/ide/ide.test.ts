...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders OPENHACK_CALLER", () => {
    process.env["OPENHACK_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode OPENHACK_CALLER", () => {
    process.env["OPENHACK_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown OPENHACK_CALLER", () => {
    process.env["OPENHACK_CALLER"] = "unknown"
