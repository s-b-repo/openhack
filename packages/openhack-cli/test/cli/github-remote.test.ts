...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/s-b-repo/openhack.git")).toEqual({ owner: "s-b-repo", repo: "openhack" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/s-b-repo/openhack")).toEqual({ owner: "s-b-repo", repo: "openhack" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:s-b-repo/openhack.git")).toEqual({ owner: "s-b-repo", repo: "openhack" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:s-b-repo/openhack")).toEqual({ owner: "s-b-repo", repo: "openhack" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/s-b-repo/openhack.git")).toEqual({ owner: "s-b-repo", repo: "openhack" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/s-b-repo/openhack")).toEqual({ owner: "s-b-repo", repo: "openhack" })
})
