...
describe("ProxyUtil", () => {
  ...
  describe("headers", () => {
    ...
    test("strips openhack-specific headers", () => {
      const req = new Request("http://localhost", {
        headers: {
          "x-openhack-directory": "/home/user/project",
      ...
      const result = ProxyUtil.headers(req)
      expect(result.get("x-openhack-directory")).toBeNull()
      expect(result.get("x-openhack-workspace")).toBeNull()
