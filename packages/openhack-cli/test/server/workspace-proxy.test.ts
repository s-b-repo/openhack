...
describe("HttpApi workspace proxy", () => {
  ...
  it.live("strips openhack-internal headers and merges extra headers", () =>
    Effect.gen(function* () {
      ...
      expect(forwarded["x-openhack-directory"]).toBeUndefined()
      expect(forwarded["x-openhack-workspace"]).toBeUndefined()
