import type { Hooks, PluginInput } from "@openhack-ai/plugin"
import type { Model } from "@openhack-ai/sdk/v2"
import { InstallationVersion } from "@openhack-ai/core/installation/version"
import { OauthCallbackPage } from "@openhack-ai/core/oauth/page"
      ...
      methods: [
        {
          ...
          async authorize() {
            ...
            return {
              url,
              instructions:
                "Sign in to DigitalOcean in your browser. OpenHack will use your DigitalOcean API token directly for inference and load your Inference Routers. Re-run /connect to refresh routers later.",
