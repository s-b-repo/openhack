...
import { OpenHackPlugin } from "../../../openhack/src/plugin"
...
export class Service extends Context.Service<Service, Interface>()("@openhack/Plugin") {}
...
function internalPlugins(flags: RuntimeFlags.Info): PluginInstance[] {
  return [
    ...
    XaiAuthPlugin,
    // OpenHack security runtime — self-gates on a `.openhack/` directory, so it
    // registers no hooks (zero overhead) in non-OpenHack projects.
    OpenHackPlugin,
  ]
}
