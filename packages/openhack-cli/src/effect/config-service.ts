 ...
 *   "@openhack/ServerAuthConfig",
 *   {
 *     password: Config.string("OPENHACK_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("OPENHACK_SERVER_USERNAME").pipe(Config.withDefault("openhack")),
 *   },
 * ) {}
 *
