...
>()("@openhack/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@openhack/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceV2.ID | undefined {
  return Flag.OPENHACK_WORKSPACE_ID ? WorkspaceV2.ID.make(Flag.OPENHACK_WORKSPACE_ID) : undefined
}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return url.searchParams.get("directory") || request.headers["x-openhack-directory"] || process.cwd()
}
