...
import { OpenHackHttpApi } from "./api"
...
const LegacyComponentDescriptions: Record<string, string> = {
  LogLevel: "Log level",
  ServerConfig: "Server configuration for openhack serve and web commands",
...
function fixSelfReferencingComponents(spec: OpenApiSpec) {
  ...
  const raw: OpenApiSpec = OpenApi.fromApi(OpenHackHttpApi)
...
export const PublicApi = OpenHackHttpApi.annotateMerge(
  OpenApi.annotations({
    title: "openhack",
    version: "1.0.0",
    description: "openhack api",
