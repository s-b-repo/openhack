...
import { EventSequenceTable, EventTable } from "@openhack-ai/core/event/sql"
...
import { WorkspaceEvent } from "@openhack-ai/schema/workspace-event"
...
export class Service extends Context.Service<Service, Interface>()("@openhack/Workspace") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        OPENHACK_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        OPENHACK_WORKSPACE_ID: config.id,
        OPENHACK_EXPERIMENTAL_WORKSPACES: "true",
