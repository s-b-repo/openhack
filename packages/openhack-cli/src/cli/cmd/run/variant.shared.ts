...
//
// The saved variant persists across sessions in ~/.local/state/openhack/model.json
...
class Service extends Context.Service<Service, VariantService>()("@openhack/RunVariant") {}
