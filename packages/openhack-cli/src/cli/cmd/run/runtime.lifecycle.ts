...
import { openEditor } from "@openhack-ai/tui/editor"
import { registerOpenhackKeymap } from "@openhack-ai/tui/keymap"
...
export async function createRuntimeLifecycle(input: LifecycleInput): Promise<Lifecycle> {
  ...
  try {
    ...
    unregisterKeymap = registerOpenhackKeymap(keymap, renderer, input.tuiConfig)
