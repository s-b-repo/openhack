...
import { normalizePromptContent } from "@openhack-ai/tui/editor"
...
import { OPENHACK_BASE_MODE, useBindings } from "@openhack-ai/tui/keymap"
...
export function createPromptState(input: PromptInput): PromptState {
  ...
  const slashOptions = createMemo<SlashOption[]>(() => {
    const builtins = [
      ...
      { kind: "slash", name: "exit", display: "/exit", description: "close OpenHack" } satisfies SlashOption,
    ]
