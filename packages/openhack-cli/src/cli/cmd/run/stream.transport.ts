...
import type { Event, GlobalEvent, OpenhackClient } from "@openhack-ai/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@openhack/RunStreamTransport") {}
