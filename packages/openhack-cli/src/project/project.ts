...
import { ProjectDirectoryTable, ProjectTable } from "@openhack-ai/core/project/sql"
import { ProjectDirectories } from "@openhack-ai/core/project/directories"
...
import { which } from "@openhack-ai/core/util/which"
...
export class Service extends Context.Service<Service, Interface>()("@openhack/Project") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(Project.Vcs))(Flag.OPENHACK_FAKE_VCS)
