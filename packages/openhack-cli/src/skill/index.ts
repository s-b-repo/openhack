...
import { SkillPlugin } from "@openhack-ai/core/plugin/skill"
import { Permission } from "@/permission"
import { FSUtil } from "@openhack-ai/core/fs-util"
import { Config } from "@/config/config"
import { FrontmatterError } from "@openhack-ai/core/v1/config/error"
import { ConfigMarkdown } from "@/config/markdown"
import { RuntimeFlags } from "@/effect/runtime-flags"
import { Glob } from "@openhack-ai/core/util/glob"
...
const OPENHACK_SKILL_PATTERN = "{skill,skills}/**/SKILL.md"
const SKILL_PATTERN = "**/SKILL.md"

// Built-in skill that ships with openhack. The model's intuition for what an
// openhack.json should look like is often wrong, and openhack hard-fails on
// invalid config, so users hit cryptic startup errors. Loading this skill
// when the model is asked to touch openhack's own config files gives it the
// actual schemas instead of guesses.
const CUSTOMIZE_OPENHACK_SKILL_NAME = "customize-openhack"
const CUSTOMIZE_OPENHACK_SKILL_DESCRIPTION =
...
const CUSTOMIZE_OPENHACK_SKILL_BODY = SkillPlugin.CustomizeOpenhackContent
...
const discoverSkills = Effect.fnUntraced(function* (
  ...
  for (const dir of configDirs) {
    yield* scan(state, dir, OPENHACK_SKILL_PATTERN)
  }
...
export class Service extends Context.Service<Service, Interface>()("@openhack/Skill") {}
  ...
  Effect.gen(function* () {
    ...
    const state = yield* InstanceState.make(
      Effect.fn("Skill.state")(function* () {
        ...
        s.skills[CUSTOMIZE_OPENHACK_SKILL_NAME] = {
          name: CUSTOMIZE_OPENHACK_SKILL_NAME,
          description: CUSTOMIZE_OPENHACK_SKILL_DESCRIPTION,
          location: "<built-in>",
          content: CUSTOMIZE_OPENHACK_SKILL_BODY,
        }
