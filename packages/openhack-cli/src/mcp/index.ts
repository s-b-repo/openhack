...
import { ConfigMCPV1 } from "@openhack-ai/core/v1/config/mcp"
...
import { McpEvent } from "@openhack-ai/schema/mcp-event"

const DEFAULT_TIMEOUT = 30_000
const CLIENT_OPTIONS = {
  capabilities: {
    // https://github.com/anomalyco/openhack/issues/11948
    // sampling: {},
    // https://github.com/anomalyco/openhack/issues/23066
    // elicitation: {},
    // https://github.com/anomalyco/openhack/issues/2308
    roots: {},
    // https://github.com/anomalyco/openhack/issues/28567
    // tasks: {},
  },
...
function createClient(directory: string) {
  const client = new Client({ name: "openhack", version: InstallationVersion }, CLIENT_OPTIONS)
...
export class Service extends Context.Service<Service, Interface>()("@openhack/MCP") {}
            ...
            if (isAuthError) {
              if (lastError.message.includes("registration") || lastError.message.includes("client_id")) {
                ...
                return events
                  .publish(TuiEvent.ToastShow, {
                    title: "MCP Authentication Required",
                    message: `Server "${key}" requires authentication. Run: openhack mcp auth ${key}`,
                    variant: "warning",
                    duration: 8000,
                  })
                  .pipe(Effect.ignore, Effect.as(undefined))
