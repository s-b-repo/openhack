...
import type * as SDK from "@openhack-ai/sdk/v2"
...
import { SessionShareTable } from "@openhack-ai/core/share/sql"
...
const disabled = process.env["OPENHACK_DISABLE_SHARE"] === "true" || process.env["OPENHACK_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@openhack/ShareNext") {}
