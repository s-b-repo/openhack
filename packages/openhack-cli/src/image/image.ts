...
export class Service extends Context.Service<Service, Interface>()("@openhack/Image") {}
  ...
  Effect.gen(function* () {
    ...
    const loadPhoton = yield* Effect.cached(
      Effect.sync(() => {
        ...
        ;(globalThis as typeof globalThis & { __OPENHACK_PHOTON_WASM_PATH?: string }).__OPENHACK_PHOTON_WASM_PATH =
