...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@openhack/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@openhack/ACPDirectory") {}
