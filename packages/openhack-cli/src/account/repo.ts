...
import { AccountStateTable, AccountTable } from "@openhack-ai/core/account/sql"
...
export class Service extends Context.Service<Service, Interface>()("@openhack/AccountRepo") {}
