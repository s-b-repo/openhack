...
import { Slug } from "@openhack-ai/core/util/slug"
...
import type { ProviderMetadata, Usage } from "@openhack-ai/llm"
...
import { locationServiceMapLayer } from "@openhack-ai/core/location-services"
...
import { PartTable, SessionTable } from "@openhack-ai/core/session/sql"
...
import { NonNegativeInt, optional } from "@openhack-ai/core/schema"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".openhack", "plans")
...
export class Service extends Context.Service<Service, Interface>()("@openhack/Session") {}
