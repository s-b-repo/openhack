...
import { MAX_STEPS_PROMPT } from "@openhack-ai/core/session/runner/max-steps"
...
export class Service extends Context.Service<Service, Interface>()("@openhack/SessionPrompt") {}
