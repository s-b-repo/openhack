import { FinishReason, LLMEvent, ProviderMetadata, ToolResultValue } from "@openhack-ai/llm"
...
// Move this extraction into @openhack-ai/llm when Copilot is handled by the native runtime.
