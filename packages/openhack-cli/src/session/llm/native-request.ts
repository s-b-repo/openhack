import type { JsonSchema, LLMRequest, ProviderMetadata } from "@openhack-ai/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@openhack-ai/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @openhack-ai/llm request objects from openhack's session/AI SDK-shaped data.
  return LLM.request({
