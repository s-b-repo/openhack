...
Concrete inventory of the remaining `makeRuntime(...)`-backed facades in `packages/openhack-cli`.
...
- [x] `../core/src/filesystem.ts` (`FileSystem`) - legacy openhack service removed
