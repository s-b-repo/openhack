...
- Effect plugins import `@openhack-ai/plugin/v2/effect`, not `@openhack-ai/core`.
- Public domain values use generated `@openhack-ai/sdk` types.
...
- Define `PluginHost` domain capabilities in `@openhack-ai/plugin/v2/effect`.
