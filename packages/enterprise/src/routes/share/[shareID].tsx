import { Message, Model, Part, Session, SessionStatus, SnapshotFileDiff, UserMessage } from "@openhack-ai/sdk/v2"
import { SessionTurn } from "@openhack-ai/session-ui/session-turn"
import { SessionReview } from "@openhack-ai/session-ui/session-review"
import { DataProvider } from "@openhack-ai/session-ui/context"
import { FileComponentProvider } from "@openhack-ai/ui/context/file"
import { WorkerPoolProvider } from "@openhack-ai/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createMemo, createSignal, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@openhack-ai/ui/logo"
import { IconButton } from "@openhack-ai/ui/icon-button"
import { ProviderIcon } from "@openhack-ai/ui/provider-icon"
import { iife } from "@openhack-ai/core/util/iife"
import { Binary } from "@openhack-ai/core/util/binary"
import { NamedError } from "@openhack-ai/core/util/error"
import { DateTime } from "luxon"
import { createStore } from "solid-js/store"
import NotFound from "../[...404]"
import { Tabs } from "@openhack-ai/ui/tabs"
import { MessageNav } from "@openhack-ai/session-ui/message-nav"
import { FileSSR } from "@openhack-ai/session-ui/file-ssr"
...
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@openhack-ai/session-ui/pierre/worker").then((m) => ({
      ...
      <Show when={data()}>
        {(data) => {
          ...
          const ogImage = createMemo(() => {
            ...
            return `https://social-cards.sst.dev/openhack-share/${encodedTitle}.png?model=${modelParam}&version=${version}&id=${data().shareID}`
          })

          return (
            <>
              <Show when={info().title}>
                <Title>{info().title} | OpenHack</Title>
              </Show>
              <Meta name="description" content="openhack - The AI coding agent built for the terminal." />
                        ...
                        <div class="relative bg-background-stronger w-screen h-screen overflow-hidden flex flex-col">
                          <header class="h-12 px-6 py-2 flex items-center justify-between self-stretch bg-background-base border-b border-border-weak-base">
                            ...
                            <div class="flex gap-3 items-center">
                              ...
                              <IconButton
                                as={"a"}
                                href="https://cybersec.org.za/discord"
                                target="_blank"
                                icon="discord"
                                variant="ghost"
                              />
