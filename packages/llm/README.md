...
Schema-first LLM core for openhack. One typed request, response, event, and tool language; provider quirks live in adapters, not in calling code.

```ts
import { Effect } from "effect"
import { LLM, LLMClient } from "@openhack-ai/llm"
import { OpenAI } from "@openhack-ai/llm/providers"
...
```ts
import { OpenAI, CloudflareAIGateway } from "@openhack-ai/llm/providers"
