...
> current private `@openhack-ai/llm` API. Names and exact TypeScript signatures
> are illustrative until implementation, but the domain boundaries and defaults
> are deliberate.

## Status

- Proposed package: `@openhack-ai/ai`
...
- Secondary audience: OpenHack and other durable agent runtimes
...
import { LLM } from "@openhack-ai/ai"
import { OpenAI } from "@openhack-ai/ai/providers/openai"
...
```ts
import { Message } from "@openhack-ai/ai"
...
import { LLM, Tool } from "@openhack-ai/ai"
...
OpenHack and other durable runtimes need to own persistence, tool settlement,
...
```ts
import { LLM } from "@openhack-ai/ai/promise"
import { OpenAI } from "@openhack-ai/ai/providers/openai"
...
```ts
import { LLMSchema } from "@openhack-ai/ai/schema"
...
```ts
import { Provider, Protocol } from "@openhack-ai/ai/provider"
...
@openhack-ai/ai/promise
  Promise/AsyncIterable LLM facade

@openhack-ai/ai/schema
  serializable domain schemas

@openhack-ai/ai/provider
  experimental Provider and Protocol authoring APIs

@openhack-ai/ai/providers/openai
@openhack-ai/ai/providers/anthropic
@openhack-ai/ai/providers/google
...
```
...
| Current                                 | Proposed                                                    |
| --------------------------------------- | ----------------------------------------------------------- |
| `@openhack-ai/llm`                      | `@openhack-ai/ai`                                           |
...
OpenHack should migrate to `generateTurn` / `streamTurn`, preserving its durable
