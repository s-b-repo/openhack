...
import type { Definition } from "@openhack-ai/schema/event"
...
export const OpenHackEvent = event.schema
export type OpenHackEvent = typeof OpenHackEvent.Type
export type OpenHackEventEncoded = typeof OpenHackEvent.Encoded
