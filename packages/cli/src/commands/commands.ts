...
declare const OPENHACK_CLI_NAME: string | undefined

export const Commands = Spec.make(typeof OPENHACK_CLI_NAME === "string" ? OPENHACK_CLI_NAME : "openhack", {
  description: "OpenHack 2.0 preview command line interface",
  commands: [
    Spec.make("api", {
