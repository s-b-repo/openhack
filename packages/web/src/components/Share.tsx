...
import { IconOpenhack } from "./icons/custom"
import { ShareI18nProvider, formatCurrency, formatNumber, normalizeLocale } from "./share/common"
import styles from "./share.module.css"
import type { MessageV2 } from "openhack/session/message-v2"
import type { Message } from "openhack/session/message"
import type { Session } from "openhack/session/index"
          ...
          <div data-component="header">
            ...
            <div data-component="header-details">
              <ul data-component="header-stats">
                <li title={props.messages.openhack_version} data-slot="item">
                  <div data-slot="icon" title={props.messages.openhack_name}>
                    <IconOpenhack width={16} height={16} />
                  </div>
