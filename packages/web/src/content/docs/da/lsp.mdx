---
title: LSP-servere
description: OpenHack integreres med dine LSP-servere.
---

OpenHack kan integreres med Language Server Protocol (LSP)-servere for at bruge diagnostik som feedback til agenten.

---

## Indbyggede

OpenHack leveres med flere indbyggede LSP-servere til populære sprog:
...
:::note
Du kan deaktivere automatisk LSP-serverdownloads ved at indstille miljøvariablen `OPENHACK_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når LSP er aktiveret, og openhack åbner en fil, vil den:
...
Du kan aktivere og tilpasse LSP-servere gennem sektionen `lsp` i din openhack-konfiguration.
