...
Brug den til at bygge integrasjoner og kontrollere openhack programmatisk.
...
Opret en forekomst av openhack:
...
Du kan sende et konfigurasjonsobjekt for at tilpasse virkemåten. Forekomsten henter fortsatt din `openhack.json`, men du kan overstyre eller tilføje til konfigurasjon inline:
...
Hvis du allerede har en kjørende forekomst av openhack, kan du oprete en klientforekomst for at koble til den:
