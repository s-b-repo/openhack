---
title: TUI
description: Korzystanie z interfejsu użytkownika terminala openhack.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

openhack zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie openhack uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI openhack, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do openhack. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Zamknij openhack. _Aliasy_: `/quit`, `/q`
...
Jest to oddzielny plik od `openhack.json`, który konfiguruje zachowanie serwera/runtime.
...
- `leader_timeout` - Określa, jak długo OpenHack czeka po naciśnięciu leader key. Domyślnie `2000`.
...
- `sound_pack` - ID sound pack do użycia. Domyślnie `openhack.default`.
