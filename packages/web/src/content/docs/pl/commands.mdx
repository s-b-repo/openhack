...
Utwórz `.openhack/commands/test.md`:
...
Możesz zdefiniować polecenia w `openhack.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji openhack:
...
- Globalnie: `~/.config/openhack/commands/`
- Na projekt: `.openhack/commands/`
...
openhack zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
