---
title: Zen
description: Wyselekcjonowana lista modeli dostarczonych przez OpenHack.
---
...
OpenHack Zen to lista przetestowanych i zweryfikowanych modeli udostępniana przez zespół OpenHack.

Zen działa jak każdy inny dostawca w OpenHack. Logujesz się do OpenHack Zen i otrzymujesz
...
:::tip
Przetestowaliśmy wybraną grupę modeli i dostawców, którzy dobrze współpracują z OpenHack.
:::
...
OpenHack Zen to brama AI, która daje dostęp do tych modeli.

---

## Jak to działa

OpenHack Zen działa jak każdy inny dostawca w OpenHack.

1. Logujesz się do **<a href={console}>OpenHack Zen</a>**, dodajesz dane
   rozliczeniowe i kopiujesz swój klucz API.
2. Uruchamiasz polecenie `/connect` w TUI, wybierasz OpenHack Zen i wklejasz swój klucz API.
...
[ID modelu](/docs/config/#models) w Twojej konfiguracji OpenHack używa formatu
`openhack/<model-id>`. Na przykład dla GPT 5.5 użyjesz w konfiguracji
`openhack/gpt-5.5`.
...
- DeepSeek V4 Flash Free jest dostępny w OpenHack przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- MiMo-V2.5 Free jest dostępny w OpenHack przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- North Mini Code Free jest dostępny w OpenHack przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Nemotron 3 Ultra Free jest dostępny w OpenHack przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Big Pickle to stealth model, który jest darmowy w OpenHack przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
...
4. Nie tworzyć **lock-in**, pozwalając używać tego z dowolnym innym agentem kodującym. I zawsze pozwalać Ci używać w OpenHack także dowolnego innego dostawcy.
