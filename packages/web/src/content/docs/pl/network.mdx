...
openhack obsługa standardowego zmiennego proxy i certyfikatów dla usług sieciowych przedsiębiorstw.

---

## Pełnomocnik

openhack respektuje standardowe zmienne środowiskowe proxy.
...
Jeśli Twoje przedsiębiorstwo korzysta z niestandardowych usług, urzędów dostępu do HTTPS, skonfiguruj openhack tak, aby im ufać.
