---
title: Paylasim
description: openhack konusmalarini genel baglantilarla paylasin.
---

openhack'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda openhack:
...
openhack, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak openhack manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `openhack.json` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda openhack kullanimi icin [daha fazla bilgi alin](/docs/enterprise).
