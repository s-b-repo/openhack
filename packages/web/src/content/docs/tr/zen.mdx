---
title: Zen
description: openhack tarafından sağlanan seçilmiş modeller listesi.
---
...
OpenHack Zen, OpenHack ekibi tarafından test edilip doğrulanmış modellerin bir listesidir.

Zen, OpenHack'daki diğer sağlayıcılar gibi çalışır. OpenHack Zen'de oturum açıp API anahtarınızı alırsınız. Bu **tamamen isteğe bağlıdır** ve OpenHack kullanmak için buna ihtiyacınız yoktur.
...
:::tip
OpenHack ile iyi çalışan seçili bir model ve sağlayıcı grubunu test ettik.
:::
...
OpenHack Zen, bu modellere erişmenizi sağlayan bir AI ağ geçididir.

---

## Nasıl çalışır

OpenHack Zen, OpenHack'daki diğer sağlayıcılar gibi çalışır.

1. **<a href={console}>OpenHack Zen</a>**'de oturum açın, faturalandırma bilgilerinizi ekleyin ve API anahtarınızı kopyalayın.
2. TUI'de `/connect` komutunu çalıştırın, OpenHack Zen'i seçin ve API anahtarınızı yapıştırın.
...
OpenHack yapılandırmanızdaki [model id](/docs/config/#models) `openhack/<model-id>` biçimini kullanır. Örneğin, GPT 5.5 için yapılandırmanızda `openhack/gpt-5.5` kullanırsınız.
...
- DeepSeek V4 Flash Free, sınırlı bir süre için OpenHack'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- MiMo-V2.5 Free, sınırlı bir süre için OpenHack'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- North Mini Code Free, sınırlı bir süre için OpenHack'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Nemotron 3 Ultra Free, sınırlı bir süre için OpenHack'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Big Pickle, sınırlı bir süre için OpenHack'da ücretsiz olan gizli bir modeldir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
...
OpenHack Zen'i şunlar için oluşturduk:
...
4. Başka herhangi bir kodlama ajanıyla kullanmanıza izin vererek **kilitlenme olmamasını** sağlamak. Ayrıca OpenHack ile her zaman başka herhangi bir sağlayıcıyı da kullanabilmenizi sağlamak.
