---
title: Özel Araçlar
description: LLM'un openhack'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. openhack'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Yerel olarak bunları projenizin `.openhack/tools/` dizinine yerleştirerek.
- Veya küresel olarak bunları `~/.config/openhack/tools/` içine yerleştirerek.
