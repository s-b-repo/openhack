...
สร้าง `.openhack/commands/test.md`:
...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ OpenHack:
...
- ระดับผู้ใช้ (Global): `~/.config/openhack/commands/`
- ระดับโปรเจ็กต์: `.openhack/commands/`
...
OpenHack มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
