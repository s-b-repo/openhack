---
title: Zen
description: Lista selecionada de modelos fornecidos pelo OpenHack.
---
...
O OpenHack Zen é uma lista de modelos testados e verificados fornecidos pela equipe do OpenHack.

O Zen funciona como qualquer outro provedor no OpenHack. Você faz login no OpenHack Zen e recebe sua chave de API. É **completamente opcional** e você não precisa usá-lo para usar o OpenHack.
...
:::tip
Testamos um grupo selecionado de modelos e provedores que funcionam bem com o OpenHack.
:::
...
O OpenHack Zen é um gateway de AI que dá a você acesso a esses modelos.

---

## Como funciona

O OpenHack Zen funciona como qualquer outro provedor no OpenHack.

1. Você faz login no **<a href={console}>OpenHack Zen</a>**, adiciona seus dados de cobrança e copia sua chave de API.
2. Você executa o comando `/connect` no TUI, seleciona OpenHack Zen e cola sua chave de API.
...
O [model id](/docs/config/#models) na sua configuração do OpenHack usa o formato `openhack/<model-id>`. Por exemplo, para GPT 5.5, você usaria `openhack/gpt-5.5` na sua configuração.
...
- DeepSeek V4 Flash Free está disponível no OpenHack por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- MiMo-V2.5 Free está disponível no OpenHack por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- North Mini Code Free está disponível no OpenHack por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- Nemotron 3 Ultra Free está disponível no OpenHack por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- Big Pickle é um modelo stealth que está gratuito no OpenHack por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
...
4. Não ter **lock-in**, permitindo que você o use com qualquer outro agente de codificação. E sempre permitir que você use qualquer outro provedor com o OpenHack também.
