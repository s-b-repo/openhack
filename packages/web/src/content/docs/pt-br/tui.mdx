---
title: TUI
description: Usando a interface de usuário de terminal openhack.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

O openhack fornece uma interface de terminal interativa ou TUI para trabalhar em seus projetos com um LLM.

Executar openhack inicia o TUI para o diretório atual.
...
Ao usar o TUI do openhack, você pode digitar `/` seguido pelo nome de um comando para executar ações rapidamente. Por exemplo:
...
Adicione um provedor ao openhack. Permite que você selecione entre os provedores disponíveis e adicione suas chaves de API.
...
Saia do openhack. _Aliases_: `/quit`, `/q`
...
Isso é separado do `openhack.json`, que configura o comportamento do servidor/runtime.
...
- `leader_timeout` - Controla por quanto tempo o OpenHack espera depois da leader key. O padrão é `2000`.
...
- `sound_pack` - ID do sound pack a ser usado. O padrão é `openhack.default`.
