---
title: TUI
description: Korištenje korisničkog interfejsa OpenHack terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

OpenHack pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje OpenHack pokreće TUI za trenutni direktorij.
...
Kada koristite OpenHack TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u OpenHack. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz OpenHack. _Aliases_: `/quit`, `/q`
...
Ovo je odvojeno od `openhack.json`, koji konfiguriše ponašanje servera/izvršavanja.
...
- `leader_timeout` - Kontroliše koliko dugo OpenHack čeka nakon leader key. Podrazumijevano je `2000`.
...
- `sound_pack` - Sound pack ID koji se koristi. Podrazumijevano je `openhack.default`.
