...
Kreiraj `.openhack/commands/test.md`:
...
Možete dodati prilagođene komande kroz OpenHack konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom OpenHack [config](/docs/config):
...
- Globalno: `~/.config/openhack/commands/`
- Po projektu: `.openhack/commands/`
...
OpenHack uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
