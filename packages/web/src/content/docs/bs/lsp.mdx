---
title: LSP serveri
description: OpenHack se integriše sa vašim LSP serverima.
---

OpenHack se može integrisati sa Language Server Protocol (LSP) serverima kako bi koristio dijagnostiku kao feedback za agenta.

## Ugrađeni

OpenHack dolazi sa nekoliko ugrađenih LSP servera za popularne jezike:
...
:::note
Možete onemogućiti automatska preuzimanja LSP servera tako što ćete postaviti varijablu okruženja `OPENHACK_DISABLE_LSP_DOWNLOAD` na `true`.
:::
...
Kada je LSP omogućen i openhack otvori fajl, on:
...
Možete omogućiti i prilagoditi LSP servere kroz `lsp` odjeljak u vašoj openhack konfiguraciji.
