---
title: Dijeljenje
description: Dijelite OpenHack razgovore javnim linkovima.
---

OpenHack opcija dijeljenja vam omogucava da kreirate javne linkove za razgovore. Tako lakse saradujete s timom ili trazite pomoc od drugih.
...
Kada podijelite razgovor, OpenHack:
...
OpenHack podrzava tri nacina dijeljenja koji odreduju kako se razgovori dijele:

---

### Ručno (zadano)

Po defaultu, OpenHack koristi rucni nacin dijeljenja. Sesije se ne dijele automatski, ali ih mozete rucno podijeliti komandom `/share`:
...
Da ovo vazi za cijeli tim u odredenom projektu, dodajte postavku u projektni `openhack.json` i commitujte u Git.
...
[Saznajte vise](/docs/enterprise) o koristenju openhack u organizaciji.
