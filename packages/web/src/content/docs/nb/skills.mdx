...
Agentferdigheter lar OpenHack oppdage gjenbrukbare instruksjoner fra repo- eller hjemmekatalogen din.
...
For prosjektlokale stier går openhack opp fra din nåværende arbeidskatalog til den når git-arbeidstreet.
...
openhack viser tilgjengelige ferdigheter i `skill`-verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved å bruke mønsterbaserte tillatelser i `openhack.json`:
