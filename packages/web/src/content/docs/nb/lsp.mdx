---
title: LSP-servere
description: openhack integreres med LSP-serverne dine.
---

OpenHack kan integreres med Language Server Protocol (LSP)-servere for å bruke diagnostikk som tilbakemelding til agenten.

---

## Innebygde servere

OpenHack kommer med flere innebygde LSP-servere for populære språk:
...
:::note
Du kan deaktivere automatiske LSP-servernedlastinger ved å sette miljøvariabelen `OPENHACK_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når LSP er aktivert og openhack åpner en fil, gjør den:
...
Du kan aktivere og tilpasse LSP-servere gjennom `lsp`-delen i OpenHack-konfigurasjonen.
