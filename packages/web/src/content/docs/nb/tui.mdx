---
title: TUI
description: Bruke openhack-terminalbrukergrensesnittet.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

OpenHack gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre OpenHack starter TUI for gjeldende katalog.
...
Når du bruker OpenHack TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til OpenHack. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Avslutt OpenHack. _Aliaser_: `/quit`, `/q`
...
Dette er atskilt fra `openhack.json`, som konfigurerer server-/kjøretidsoppførsel.
...
- `leader_timeout` - Styrer hvor lenge OpenHack venter etter leader key. Standard er `2000`.
...
- `sound_pack` - Sound pack-ID som skal brukes. Standard er `openhack.default`.
