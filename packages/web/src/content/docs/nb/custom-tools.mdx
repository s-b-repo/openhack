...
description: Lag verktøy som LLM kan kalle inn OpenHack.
---

Egendefinerte verktøy er funksjoner du oppretter som LLM kan kalle under samtaler. De fungerer sammen med OpenHack sine [innebygde verktøy](/docs/tools) som `read`, `write` og `bash`.
...
- Lokalt ved å plassere dem i `.openhack/tools/`-katalogen til prosjektet ditt.
- Eller globalt, ved å plassere dem i `~/.config/openhack/tools/`.
