---
title: Zen
description: Utvalgt liste over modeller levert av OpenHack.
---
...
OpenHack Zen er en liste over testede og verifiserte modeller levert av OpenHack-teamet.

Zen fungerer som enhver annen leverandør i OpenHack. Du logger inn på OpenHack Zen og får
...
:::tip
Vi testet en utvalgt gruppe modeller og leverandører som fungerer godt med OpenHack.
:::
...
OpenHack Zen er en AI gateway som gir deg tilgang til disse modellene.

---

## Slik fungerer det

OpenHack Zen fungerer som enhver annen leverandør i OpenHack.

1. Du logger inn på **<a href={console}>OpenHack Zen</a>**, legger til
   faktureringsdetaljene dine og kopierer API-nøkkelen din.
2. Du kjører kommandoen `/connect` i TUI, velger OpenHack Zen og limer inn API-nøkkelen din.
...
[modell-id](/docs/config/#models) i OpenHack-konfigurasjonen din
bruker formatet `openhack/<model-id>`. For eksempel, for GPT 5.5, ville du
brukt `openhack/gpt-5.5` i konfigurasjonen din.
...
- DeepSeek V4 Flash Free er tilgjengelig på OpenHack i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- MiMo-V2.5 Free er tilgjengelig på OpenHack i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- North Mini Code Free er tilgjengelig på OpenHack i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Nemotron 3 Ultra Free er tilgjengelig på OpenHack i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Big Pickle er en stealth-modell som er gratis på OpenHack i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
...
Vi opprettet OpenHack Zen for å:
...
4. Ha **ingen lock-in** ved å la deg bruke det med enhver annen kodeagent. Og alltid la deg bruke enhver annen leverandør med OpenHack også.
