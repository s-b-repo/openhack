...
Opprett `.openhack/commands/test.md`:
...
Du kan legge til egendefinerte kommandoer gjennom OpenHack-konfigurasjonen eller ved å lage markdown-filer i katalogen `commands/`.

---

### JSON

Bruk alternativet `command` i OpenHack [config](/docs/config):
...
- Per prosjekt: `.openhack/commands/`
...
OpenHack inkluderer flere innebygde kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [finn ut mer](/docs/tui#commands).
