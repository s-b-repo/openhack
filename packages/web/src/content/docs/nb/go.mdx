...
OpenHack Go er et lavkostnadsabonnement — **$5 for din første måned**, deretter **$10/måned** — som gir deg pålitelig tilgang til populære åpne kodemodeller.

Go fungerer som enhver annen leverandør i OpenHack. Du abonnerer på OpenHack Go og
...
OpenHack Go gir deg tilgang til disse modellene for **$5 for din første måned**, deretter **$10/måned**.

---

## Hvordan det fungerer

OpenHack Go fungerer som enhver annen leverandør i OpenHack.

1. Du logger inn på **<a href={console}>OpenHack Zen</a>**, abonnerer på Go, og
   kopierer din API-nøkkel.
2. Du kjører kommandoen `/connect` i TUI-en, velger `OpenHack Go`, og limer inn
   din API-nøkkel.
3. Kjør `/models` i TUI-en for å se listen over modeller som er tilgjengelige gjennom Go.

:::note
Kun ett medlem per arbeidsområde kan abonnere på OpenHack Go.
:::
...
OpenHack Go inkluderer følgende grenser:
...
[Modell-ID-en](/docs/config/#models) i din OpenHack-konfigurasjon
bruker formatet `openhack-go/<model-id>`. For eksempel, for Kimi K2.7 Code, vil du
bruke `openhack-go/kimi-k2.7-code` i konfigurasjonen din.
...
Vi opprettet OpenHack Go for å:
...
4. Ha **ingen innelåsing** ved å la deg bruke en hvilken som helst annen leverandør med OpenHack også.
