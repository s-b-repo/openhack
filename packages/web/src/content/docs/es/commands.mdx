...
Crear `.openhack/commands/test.md`:
...
Puede agregar comandos personalizados a través de la configuración OpenHack o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su OpenHack [config](/docs/config):
...
- Por proyecto: `.openhack/commands/`
...
openhack incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
