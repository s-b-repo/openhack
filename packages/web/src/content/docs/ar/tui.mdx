---
title: TUI
description: استخدام واجهة المستخدم TUI في OpenHack.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

يوفّر OpenHack واجهة terminal تفاعلية (TUI) للعمل على مشاريعك باستخدام LLM.

يؤدي تشغيل OpenHack إلى بدء واجهة TUI للدليل الحالي.
...
عند استخدام واجهة OpenHack في terminal، يمكنك كتابة `/` متبوعة باسم أمر لتنفيذ الإجراءات بسرعة. مثلا:
...
أضف موفّرا إلى OpenHack. يتيح لك اختيار أحد الموفّرين المتاحين وإضافة مفاتيح API الخاصة بهم.
...
اخرج من OpenHack. _الأسماء المستعارة_: `/quit`, `/q`
...
هذا منفصل عن `openhack.json`، الذي يضبط سلوك الخادم ووقت التشغيل.
...
- `leader_timeout` - يتحكم في مدة انتظار OpenHack بعد الضغط على leader key. القيمة الافتراضية `2000`.
...
- `sound_pack` - sound pack ID المراد استخدامه. القيمة الافتراضية `openhack.default`.
