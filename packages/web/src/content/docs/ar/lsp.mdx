---
title: خوادم LSP
description: يتكامل OpenHack مع خوادم LSP لديك.
---

يمكن أن يتكامل OpenHack مع خوادم Language Server Protocol (LSP) لاستخدام التشخيصات كملاحظات للوكيل.

---

## المدمجة

يأتي OpenHack مع عدة خوادم LSP مدمجة للغات الشائعة:
...
:::note
يمكنك تعطيل تنزيلات خوادم LSP التلقائية عبر ضبط متغير البيئة `OPENHACK_DISABLE_LSP_DOWNLOAD` على `true`.
:::
...
عند تفعيل LSP وفتح openhack لملف، فإنه:
...
يمكنك تفعيل خوادم LSP وتخصيصها عبر قسم `lsp` في إعدادات openhack.
