...
description: أنشئ أدوات يمكن لـ LLM استدعاؤها في openhack.
---

الأدوات المخصصة هي دوال تنشئها يمكن لـ LLM استدعاؤها أثناء المحادثات. تعمل جنبا إلى جنب مع [الأدوات المدمجة](/docs/tools) في openhack مثل `read` و`write` و`bash`.
...
- محليا بوضعها في مجلد `.openhack/tools/` داخل مشروعك.
- أو عالميا بوضعها في `~/.config/openhack/tools/`.
