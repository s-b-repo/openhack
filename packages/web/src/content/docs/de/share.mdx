---
title: Teilen
description: Teile OpenHack-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu OpenHack-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht OpenHack Folgendes:
...
OpenHack hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt OpenHack den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`openhack.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du openhack in deiner Organisation einsetzt.
