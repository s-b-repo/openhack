---
title: SDK
description: Typsicherer JS-Client fuer den openhack-Server.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

Das openhack JS/TS SDK bietet einen typsicheren Client fuer die Server-API.
Damit kannst du Integrationen bauen und openhack programmatisch steuern.
...
Erstelle eine openhack-Instanz:
...
`openhack.json` wird weiterhin geladen, kann aber inline ueberschrieben oder erweitert werden:
...
Wenn openhack bereits laeuft, kannst du nur einen Client erstellen und verbinden:
