---
title: Zen
description: Lista curata di modelli fornita da OpenHack.
---
...
OpenHack Zen è un elenco di modelli testati e verificati forniti dal team di OpenHack.

Zen funziona come qualsiasi altro provider in OpenHack. Accedi a OpenHack Zen e ottieni
...
:::tip
Abbiamo testato un gruppo selezionato di modelli e provider che funzionano bene con OpenHack.
:::
...
OpenHack Zen è un gateway AI che ti dà accesso a questi modelli.

---

## Come funziona

OpenHack Zen funziona come qualsiasi altro provider in OpenHack.

1. Accedi a **<a href={console}>OpenHack Zen</a>**, aggiungi i dettagli di fatturazione,
   e copia la tua chiave API.
2. Esegui il comando `/connect` nella TUI, seleziona OpenHack Zen, e incolla la tua chiave API.
...
Il [model id](/docs/config/#models) nella config di OpenHack
usa il formato `openhack/<model-id>`. Per esempio, per GPT 5.5, useresti
`openhack/gpt-5.5` nella tua config.
...
- DeepSeek V4 Flash Free è disponibile su OpenHack per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- MiMo-V2.5 Free è disponibile su OpenHack per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- North Mini Code Free è disponibile su OpenHack per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- Nemotron 3 Ultra Free è disponibile su OpenHack per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- Big Pickle è un modello stealth che è gratuito su OpenHack per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
...
Abbiamo creato OpenHack Zen per:
...
4. Non avere **lock-in** permettendoti di usarlo con qualsiasi altro agente di coding. E permettendoti sempre di usare anche qualsiasi altro provider con OpenHack.
