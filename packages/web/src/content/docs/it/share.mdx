---
title: Condivisione
description: Condividi le tue conversazioni OpenHack.
---

La funzione di condivisione di OpenHack ti permette di creare link pubblici alle tue conversazioni, cosi puoi collaborare con i colleghi o chiedere aiuto ad altre persone.
...
Quando condividi una conversazione, OpenHack:
...
OpenHack supporta tre modalita di condivisione che controllano come vengono condivise le conversazioni:

---

### Manuale (predefinito)

Per impostazione predefinita, OpenHack usa la condivisione manuale. Le sessioni non vengono condivise automaticamente, ma puoi condividerle manualmente con il comando `/share`:
...
Per applicarlo al tuo team in un progetto specifico, aggiungilo a `openhack.json` nel progetto e versionalo su Git.
...
[Scopri di piu](/docs/enterprise) su come usare openhack nella tua organizzazione.
