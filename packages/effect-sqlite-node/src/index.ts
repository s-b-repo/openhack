...
export const TypeId: TypeId = "~@openhack-ai/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@openhack-ai/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@openhack-ai/effect-sqlite-node/NodeSqliteClient")
