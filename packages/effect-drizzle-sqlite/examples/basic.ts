...
class Database extends Context.Service<Database, DatabaseShape>()("@openhack/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@openhack/example/UserStore") {
