...
import desktopAppIcon from "../../asset/lander/openhack-desktop-icon.png"
      ...
      <div data-component="container">
        ...
        <div data-component="content">
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button
                ...
                onClick={handleCopyClick("curl -fsSL https://cybersec.org.za/install | bash")}
              >
                <code>
                  curl -fsSL https://<strong>cybersec.org.za/install</strong> | bash
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("npm i -g openhack-ai")}>
                <code>
                  npm i -g <strong>openhack-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("bun add -g openhack-ai")}>
                <code>
                  bun add -g <strong>openhack-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("brew install anomalyco/tap/openhack")}>
                <code>
                  brew install <strong>anomalyco/tap/openhack</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("paru -S openhack")}>
                <code>
                  paru -S <strong>openhack</strong>
                </code>
                <CopyStatus />
              </button>
            </div>
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button data-component="cli-row" onClick={handleCopyClick("brew install --cask openhack-desktop")}>
                <code>
                  brew install --cask <strong>openhack-desktop</strong>
                </code>
                <CopyStatus />
              </button>
