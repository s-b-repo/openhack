...
import compareVideo from "../../asset/lander/openhack-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/openhack-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="openhack:auth" content={loggedin() ? "true" : "false"} />
