...
import { and, Database, eq, isNull, lt, or, sql } from "@openhack-ai/console-core/drizzle/index.js"
import { KeyTable } from "@openhack-ai/console-core/schema/key.sql.js"
import { BillingTable, LiteTable, SubscriptionTable, UsageTable } from "@openhack-ai/console-core/schema/billing.sql.js"
import { centsToMicroCents } from "@openhack-ai/console-core/util/price.js"
import { getMonthlyBounds, getWeekBounds } from "@openhack-ai/console-core/util/date.js"
import { Identifier } from "@openhack-ai/console-core/identifier.js"
import { Billing } from "@openhack-ai/console-core/billing.js"
import { Actor } from "@openhack-ai/console-core/actor.js"
import { WorkspaceTable } from "@openhack-ai/console-core/schema/workspace.sql.js"
import { ZenData } from "@openhack-ai/console-core/model.js"
import { Subscription } from "@openhack-ai/console-core/subscription.js"
import { BlackData } from "@openhack-ai/console-core/black.js"
import { UserTable } from "@openhack-ai/console-core/schema/user.sql.js"
import { ModelTable } from "@openhack-ai/console-core/schema/model.sql.js"
import { ProviderTable } from "@openhack-ai/console-core/schema/provider.sql.js"
...
import { LiteData } from "@openhack-ai/console-core/lite.js"
import { Resource } from "@openhack-ai/console-resource"
...
import { Workspace } from "@openhack-ai/console-core/workspace.js"
...
export async function handler(
  ...
  try {
    ...
    const sessionId = input.request.headers.get("x-openhack-session") ?? ""
    const requestId = input.request.headers.get("x-openhack-request") ?? ""
    const ocClient = input.request.headers.get("x-openhack-client") ?? ""
    const projectId = input.request.headers.get("x-openhack-project") ?? ""
      ...
      if (!allowedRegions?.includes("unavailable"))
        throw new RegionError(
          t("zen.api.error.regionNotAllowed", {
            consoleGoUrl: `https://cybersec.org.za/workspace/${authInfo.workspaceID}/go`,
          }),
        )
    }
    */
    ...
    const retriableRequest = async (retry: RetryOptions = { excludeProviders: [], retryCount: 0 }) => {
      ...
      const res = await fetchWith429Retry(reqUrl, {
        ...
        headers: (() => {
          ...
          headers.delete("x-openhack-request")
          headers.delete("x-openhack-session")
          headers.delete("x-openhack-project")
          headers.delete("x-openhack-client")
          return headers
        })(),
        body: reqBody,
      ...
      if (providerInfo.id.startsWith("console.") || providerInfo.id.startsWith("console-go.")) {
        const resEndpointId = res.headers.get("x-openhack-endpoint-id")
        const resEndpointModelId = res.headers.get("x-openhack-upstream-model-id")
  ...
  function validateBilling(authInfo: AuthInfo, modelInfo: ModelInfo): BillingSource {
    ...
    if (opts.modelList === "lite" && authInfo.billing.lite && authInfo.lite) {
      try {
        const consoleGoUrl = `https://cybersec.org.za/workspace/${authInfo.workspaceID}/go`
    ...
    const billingUrl = `https://cybersec.org.za/workspace/${authInfo.workspaceID}/billing`
    const membersUrl = `https://cybersec.org.za/workspace/${authInfo.workspaceID}/members`
