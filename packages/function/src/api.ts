...
export default new Hono<{ Bindings: Env }>()
  ...
  .post("/exchange_github_app_token", async (c) => {
    const EXPECTED_AUDIENCE = "openhack-github-action"
  ...
  /**
   * Used by the GitHub action to get GitHub installation access token given user PAT token (used when testing `openhack github run` locally)
   */
  ...
  /**
   * Used by the openhack CLI to check if the GitHub app is installed
   */
