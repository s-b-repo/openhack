...
const en = {
  "app.title": "AI Model Usage Rankings | OpenHack Data",
  "app.description":
    "Explore OpenHack Go usage across AI models, including token volume, rankings, market share, token pricing, session cost, cache ratio, and geo breakdowns.",
  "app.unfurlAlt": "OpenHack Data wordmark on a dark patterned background",
  ...
  "header.githubAria": "Star OpenHack on GitHub",
  "header.github": "GitHub",
  "header.tryOpenHack": "Try OpenHack",
  ...
  "home.topModelsDescription": "Usage of models across OpenHack Go.",
  ...
  "home.uniqueUsersDescription": "Daily unique OpenHack Go users by model.",
  ...
  "lab.title": "{{lab}} AI Model Usage & Rankings | OpenHack Data",
  "lab.description":
    "Compare {{lab}} models used in OpenHack Go, including token usage, model rankings, context windows, release dates, costs, and model-specific data.",
  "lab.loadingTitle": "Model Lab",
  "lab.loadingDescription": "Reading model availability and recent OpenHack usage.",
  "lab.notFound": "No models matched this lab.",
  "lab.heroPrefix": "Explore {{count}} {{lab}} models used in OpenHack",
  ...
  "lab.shareOfUsage": "{{share}} of recent OpenHack usage",
  ...
  "lab.usage": "Usage",
  "lab.share": "Share",
  "model.title": "{{model}} Usage, Cost & Rank | OpenHack Data",
  "model.description":
    "View {{model}} OpenHack Go usage data, including token volume, weekly rank, token mix, costs, cache ratio, sessions, geo breakdowns, and peer models.",
  ...
  "model.catalogFallback":
    "Model facts from the shared model index. OpenHack Go usage appears once this model has activity.",
  "model.unranked": "Unranked across last week's OpenHack Go usage",
  "model.ranked": "Ranked #{{rank}} across last week's OpenHack Go usage",
  "model.observedVolume": "with {{share}} of observed 2M volume.",
  "model.weights": "Model weights: {{label}}",
  "model.rank": "7D Rank",
  "model.profile": "Model Profile",
  "model.listed": "Listed",
  "model.noCurrentUsage": "No OpenHack Go usage in the current data window.",
  ...
  "model.inputs": "Inputs",
  "model.overviewDescription": "Recent OpenHack Go tokens, unique users, and market position.",
  "model.noSummaryTitle": "No usage summary",
  "model.noSummaryDescription": "This model has no OpenHack Go usage rows yet.",
  "model.tokens": "Tokens",
  ...
  "model.usageDescription": "Daily OpenHack Go token volume over the recent two-month window.",
  ...
  "model.usersDescription": "Daily unique OpenHack Go users over the recent two-month window.",
  ...
  "model.efficiencyDescription": "Cost, cache behavior, and average OpenHack Go session shape.",
  ...
  "model.geoDescription": "OpenHack Go model tokens used by country.",
  "model.noGeoTitle": "No geo data",
  "model.noGeoDescription": "No OpenHack Go geo rows matched this model.",
  "model.worldMap": "World map of model token usage by country",
  "model.peersDescription": "Nearby models by recent OpenHack Go token volume.",
