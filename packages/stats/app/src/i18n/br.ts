export const dict = {
  "app.title": "Ranking de uso de modelos de IA | OpenHack Data",
  "app.description":
    "Explore o uso do OpenHack Go em modelos de IA, incluindo volume de tokens, rankings, participação de mercado, preço por token, custo por sessão, taxa de cache e distribuição geográfica.",
  "app.unfurlAlt": "Logotipo do OpenHack Data sobre um fundo escuro padronizado",
  ...
  "header.githubAria": "Dar estrela ao OpenHack no GitHub",
  "header.github": "GitHub",
  "header.tryOpenHack": "Experimente o OpenHack",
  ...
  "footer.homeAria": "Início do OpenHack",
  ...
  "modal.title": "Newsletter do OpenHack",
  ...
  "home.usageTitle": "Uso",
  "home.topModelsDescription": "Uso de modelos no OpenHack Go.",
  ...
  "home.uniqueUsersDescription": "Usuários únicos diários do OpenHack Go por modelo.",
  ...
  "lab.title": "Uso e ranking de modelos de IA da {{lab}} | OpenHack Data",
  "lab.description":
    "Compare modelos da {{lab}} usados no OpenHack Go, incluindo uso de tokens, ranking de modelos, janelas de contexto, datas de lançamento, custos e dados específicos de cada modelo.",
  "lab.loadingTitle": "Laboratório de modelos",
  "lab.loadingDescription": "Lendo disponibilidade de modelos e uso recente do OpenHack.",
  "lab.notFound": "Nenhum modelo correspondeu a este laboratório.",
  "lab.heroPrefix": "Explore {{count}} modelos da {{lab}} usados no OpenHack",
  ...
  "lab.shareOfUsage": "{{share}} do uso recente do OpenHack",
  "lab.usageTitle": "Uso de tokens da {{lab}}",
  "lab.usageDescription": "Volume diário de tokens do OpenHack nos últimos dois meses.",
  ...
  "model.title": "Uso, custo e posição de {{model}} | OpenHack Data",
  "model.description":
    "Veja dados de uso de {{model}} no OpenHack Go, incluindo volume de tokens, ranking semanal, combinação de tokens, custos, taxa de cache, sessões, distribuição geográfica e modelos pares.",
  ...
  "model.catalogFallback":
    "Fatos do modelo do índice compartilhado de modelos. O uso no OpenHack Go aparece quando este modelo tiver atividade.",
  "model.unranked": "Sem classificação no uso do OpenHack Go da última semana",
  "model.ranked": "Classificado em #{{rank}} no uso do OpenHack Go da última semana",
  ...
  "model.noCurrentUsage": "Sem uso do OpenHack Go na janela de dados atual.",
  ...
  "model.overviewDescription": "Tokens recentes do OpenHack Go, usuários únicos e posição de mercado.",
  "model.noSummaryTitle": "Sem resumo de uso",
  "model.noSummaryDescription": "Este modelo ainda não tem linhas de uso do OpenHack Go.",
  "model.tokens": "Tokens",
  ...
  "model.usageDescription": "Volume diário de tokens do OpenHack Go na janela recente de dois meses.",
  ...
  "model.usersDescription": "Usuários únicos diários do OpenHack Go na janela recente de dois meses.",
  ...
  "model.efficiencyDescription": "Custo, comportamento de cache e formato médio da sessão do OpenHack Go.",
  ...
  "model.geoDescription": "Tokens do modelo OpenHack Go usados por país.",
  "model.noGeoTitle": "Sem dados geográficos",
  "model.noGeoDescription": "Nenhuma linha geográfica do OpenHack Go correspondeu a este modelo.",
  "model.worldMap": "Mapa-múndi do uso de tokens do modelo por país",
  "model.peersDescription": "Modelos próximos por volume recente de tokens do OpenHack Go.",
