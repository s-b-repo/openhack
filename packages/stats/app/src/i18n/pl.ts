export const dict = {
  "app.title": "Rankingi użycia modeli AI | OpenHack Data",
  "app.description":
    "Przeglądaj użycie OpenHack Go w modelach AI, w tym wolumen tokenów, rankingi, udział w rynku, ceny tokenów, koszt sesji, współczynnik cache i podziały geograficzne.",
  "app.unfurlAlt": "Znak słowny OpenHack Data na ciemnym wzorzystym tle",
  ...
  "header.githubAria": "Dodaj gwiazdkę OpenHack na GitHub",
  "header.github": "GitHub",
  "header.tryOpenHack": "Wypróbuj OpenHack",
  ...
  "footer.homeAria": "Strona główna OpenHack",
  ...
  "home.topModelsDescription": "Użycie modeli w OpenHack Go.",
  ...
  "home.uniqueUsersDescription": "Dzienni unikalni użytkownicy OpenHack Go według modelu.",
  ...
  "lab.title": "Użycie i rankingi modeli AI {{lab}} | OpenHack Data",
  "lab.description":
    "Porównaj modele {{lab}} używane w OpenHack Go, w tym użycie tokenów, rankingi modeli, okna kontekstu, daty wydań, koszty i dane specyficzne dla modeli.",
  "lab.loadingTitle": "Laboratorium modeli",
  "lab.loadingDescription": "Odczytywanie dostępności modeli i ostatniego użycia OpenHack.",
  "lab.notFound": "Żadne modele nie pasowały do tego laboratorium.",
  "lab.heroPrefix": "Przeglądaj {{count}} modeli {{lab}} używanych w OpenHack",
  ...
  "lab.shareOfUsage": "{{share}} ostatniego użycia OpenHack",
  "lab.usageTitle": "Użycie tokenów {{lab}}",
  "lab.usageDescription": "Dzienny wolumen tokenów OpenHack z ostatnich dwóch miesięcy.",
  ...
  "lab.usage": "Użycie",
  "lab.share": "Udział",
  "model.title": "Użycie, koszt i pozycja {{model}} | OpenHack Data",
  "model.description":
    "Zobacz dane użycia {{model}} w OpenHack Go, w tym wolumen tokenów, tygodniową pozycję, miks tokenów, koszty, współczynnik cache, sesje, podziały geograficzne i podobne modele.",
  ...
  "model.catalogFallback":
    "Fakty modelu ze wspólnego indeksu modeli. Użycie OpenHack Go pojawi się, gdy ten model będzie mieć aktywność.",
  "model.unranked": "Bez pozycji w użyciu OpenHack Go z zeszłego tygodnia",
  "model.ranked": "Pozycja #{{rank}} w użyciu OpenHack Go z zeszłego tygodnia",
  ...
  "model.noCurrentUsage": "Brak użycia OpenHack Go w bieżącym oknie danych.",
  ...
  "model.overviewDescription": "Ostatnie tokeny OpenHack Go, unikalni użytkownicy i pozycja rynkowa.",
  "model.noSummaryTitle": "Brak podsumowania użycia",
  "model.noSummaryDescription": "Ten model nie ma jeszcze wierszy użycia OpenHack Go.",
  "model.tokens": "Tokeny",
  ...
  "model.usageDescription": "Dzienny wolumen tokenów OpenHack Go w ostatnim dwumiesięcznym oknie.",
  ...
  "model.usersDescription": "Dzienni unikalni użytkownicy OpenHack Go w ostatnim dwumiesięcznym oknie.",
  ...
  "model.efficiencyDescription": "Koszt, zachowanie cache i średni kształt sesji OpenHack Go.",
  ...
  "model.geoDescription": "Tokeny modelu OpenHack Go użyte według kraju.",
  "model.noGeoTitle": "Brak danych geograficznych",
  "model.noGeoDescription": "Żadne wiersze geograficzne OpenHack Go nie pasowały do tego modelu.",
  "model.worldMap": "Mapa świata użycia tokenów modelu według kraju",
  "model.peersDescription": "Pobliskie modele według ostatniego wolumenu tokenów OpenHack Go.",
