export const dict = {
  "app.title": "Classifiche di utilizzo dei modelli IA | OpenHack Data",
  "app.description":
    "Esplora l'utilizzo di OpenHack Go nei modelli IA, inclusi volume di token, classifiche, quota di mercato, prezzi dei token, costo per sessione, rapporto cache e ripartizioni geografiche.",
  "app.unfurlAlt": "Logotipo OpenHack Data su uno sfondo scuro con motivo",
  ...
  "header.githubAria": "Aggiungi una stella a OpenHack su GitHub",
  "header.github": "GitHub",
  "header.tryOpenHack": "Prova OpenHack",
  ...
  "home.topModelsDescription": "Utilizzo dei modelli in OpenHack Go.",
  ...
  "home.uniqueUsersDescription": "Utenti unici giornalieri di OpenHack Go per modello.",
  ...
  "lab.title": "Utilizzo e classifiche dei modelli IA {{lab}} | OpenHack Data",
  "lab.description":
    "Confronta i modelli {{lab}} usati in OpenHack Go, inclusi utilizzo dei token, classifiche dei modelli, finestre di contesto, date di rilascio, costi e dati specifici del modello.",
  "lab.loadingTitle": "Laboratorio modelli",
  "lab.loadingDescription": "Lettura della disponibilità dei modelli e dell'utilizzo recente di OpenHack.",
  "lab.notFound": "Nessun modello corrispondeva a questo laboratorio.",
  "lab.heroPrefix": "Esplora {{count}} modelli {{lab}} usati in OpenHack",
  ...
  "lab.shareOfUsage": "{{share}} dell'utilizzo recente di OpenHack",
  "lab.usageTitle": "Utilizzo token {{lab}}",
  "lab.usageDescription": "Volume giornaliero di token OpenHack negli ultimi due mesi.",
  ...
  "lab.usage": "Utilizzo",
  "lab.share": "Quota",
  "model.title": "Utilizzo, costo e posizione di {{model}} | OpenHack Data",
  "model.description":
    "Visualizza i dati di utilizzo di {{model}} in OpenHack Go, inclusi volume di token, rango settimanale, mix di token, costi, rapporto cache, sessioni, ripartizioni geografiche e modelli simili.",
  ...
  "model.catalogFallback":
    "Fatti del modello dall'indice condiviso dei modelli. L'utilizzo di OpenHack Go appare quando questo modello ha attività.",
  "model.unranked": "Non classificato nell'utilizzo OpenHack Go della scorsa settimana",
  "model.ranked": "Posizione #{{rank}} nell'utilizzo OpenHack Go della scorsa settimana",
  ...
  "model.noCurrentUsage": "Nessun utilizzo di OpenHack Go nella finestra dati attuale.",
  ...
  "model.inputs": "Input",
  "model.overviewDescription": "Token recenti di OpenHack Go, utenti unici e posizione di mercato.",
  "model.noSummaryTitle": "Nessun riepilogo di utilizzo",
  "model.noSummaryDescription": "Questo modello non ha ancora righe di utilizzo di OpenHack Go.",
  "model.tokens": "Token",
  ...
  "model.usageDescription": "Volume giornaliero di token OpenHack Go nella recente finestra di due mesi.",
  ...
  "model.usersDescription": "Utenti unici giornalieri di OpenHack Go nella recente finestra di due mesi.",
  ...
  "model.efficiencyDescription": "Costi, comportamento della cache e forma media della sessione OpenHack Go.",
  ...
  "model.geoDescription": "Token del modello OpenHack Go usati per paese.",
  "model.noGeoTitle": "Nessun dato geografico",
  "model.noGeoDescription": "Nessuna riga geografica OpenHack Go corrispondeva a questo modello.",
  "model.worldMap": "Mappa mondiale dell'utilizzo dei token del modello per paese",
  "model.peersDescription": "Modelli vicini per volume recente di token OpenHack Go.",
