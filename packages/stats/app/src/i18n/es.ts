export const dict = {
  "app.title": "Clasificaciones de uso de modelos de IA | OpenHack Data",
  "app.description":
    "Explora el uso de OpenHack Go en modelos de IA, incluido el volumen de tokens, clasificaciones, cuota de mercado, precios de tokens, coste por sesión, ratio de caché y desgloses geográficos.",
  "app.unfurlAlt": "Logotipo textual de OpenHack Data sobre un fondo oscuro con patrón",
  ...
  "header.githubAria": "Dale una estrella a OpenHack en GitHub",
  "header.github": "GitHub",
  "header.tryOpenHack": "Probar OpenHack",
  ...
  "footer.homeAria": "Inicio de OpenHack",
  ...
  "modal.title": "Boletín de OpenHack",
  ...
  "home.usageTitle": "Uso",
  "home.topModelsDescription": "Uso de modelos en OpenHack Go.",
  ...
  "home.uniqueUsersDescription": "Usuarios únicos diarios de OpenHack Go por modelo.",
  ...
  "lab.title": "Uso y clasificaciones de modelos de IA de {{lab}} | OpenHack Data",
  "lab.description":
    "Compara modelos de {{lab}} usados en OpenHack Go, incluido uso de tokens, clasificaciones de modelos, ventanas de contexto, fechas de lanzamiento, costes y datos específicos del modelo.",
  "lab.loadingTitle": "Laboratorio de modelos",
  "lab.loadingDescription": "Leyendo disponibilidad de modelos y uso reciente de OpenHack.",
  "lab.notFound": "Ningún modelo coincidió con este laboratorio.",
  "lab.heroPrefix": "Explora {{count}} modelos de {{lab}} usados en OpenHack",
  ...
  "lab.shareOfUsage": "{{share}} del uso reciente de OpenHack",
  "lab.usageTitle": "Uso de tokens de {{lab}}",
  "lab.usageDescription": "Volumen diario de tokens de OpenHack durante los últimos dos meses.",
  ...
  "lab.usage": "Uso",
  "lab.share": "Cuota",
  "model.title": "Uso, coste y posición de {{model}} | OpenHack Data",
  "model.description":
    "Consulta datos de uso de {{model}} en OpenHack Go, incluido volumen de tokens, posición semanal, mezcla de tokens, costes, ratio de caché, sesiones, desgloses geográficos y modelos similares.",
  ...
  "model.catalogFallback":
    "Datos del modelo desde el índice compartido de modelos. El uso de OpenHack Go aparecerá cuando este modelo tenga actividad.",
  "model.unranked": "Sin clasificación en el uso de OpenHack Go de la semana pasada",
  "model.ranked": "Clasificado #{{rank}} en el uso de OpenHack Go de la semana pasada",
  ...
  "model.noCurrentUsage": "Sin uso de OpenHack Go en la ventana de datos actual.",
  ...
  "model.overviewDescription": "Tokens recientes de OpenHack Go, usuarios únicos y posición de mercado.",
  "model.noSummaryTitle": "Sin resumen de uso",
  "model.noSummaryDescription": "Este modelo aún no tiene filas de uso de OpenHack Go.",
  "model.tokens": "Tokens",
  ...
  "model.usageDescription": "Volumen diario de tokens de OpenHack Go durante la ventana reciente de dos meses.",
  ...
  "model.usersDescription": "Usuarios únicos diarios de OpenHack Go durante la ventana reciente de dos meses.",
  ...
  "model.efficiencyDescription": "Coste, comportamiento de caché y forma media de sesión de OpenHack Go.",
  ...
  "model.geoDescription": "Tokens del modelo de OpenHack Go usados por país.",
  "model.noGeoTitle": "Sin datos geográficos",
  "model.noGeoDescription": "Ninguna fila geográfica de OpenHack Go coincidió con este modelo.",
  "model.worldMap": "Mapa mundial del uso de tokens del modelo por país",
  "model.peersDescription": "Modelos cercanos por volumen reciente de tokens de OpenHack Go.",
