...
# Package managers
npm i -g openhack-ai@latest        # or bun/pnpm/yarn
scoop install openhack             # Windows
choco install openhack             # Windows
brew install anomalyco/tap/openhack # macOS and Linux (recommended, always up to date)
brew install openhack              # macOS and Linux (official brew formula, updated less)
sudo pacman -S openhack            # Arch Linux (Stable)
paru -S openhack-bin               # Arch Linux (Latest from AUR)
mise use -g openhack               # Any OS
nix run nixpkgs#openhack           # or github:anomalyco/openhack for latest dev branch
```
...
OpenHack ডেস্কটপ অ্যাপ্লিকেশন হিসেবেও উপলব্ধ। সরাসরি [রিলিজ পেজ](https://github.com/anomalyco/openhack/releases) অথবা [cybersec.org.za/download](https://cybersec.org.za/download) থেকে ডাউনলোড করুন।
...
1. `$OPENHACK_INSTALL_DIR` - কাস্টম ইনস্টলেশন ডিরেক্টরি
...
4. `$HOME/.openhack/bin` - ডিফল্ট ফলব্যাক
...
OpenHack এ দুটি বিল্ট-ইন এজেন্ট রয়েছে যা আপনি `Tab` কি(key) দিয়ে পরিবর্তন করতে পারবেন।
...
এজেন্টদের সম্পর্কে আরও জানুন: [docs](https://cybersec.org.za/docs/agents)।

### ডকুমেন্টেশন (Documentation)

কিভাবে OpenHack কনফিগার করবেন সে সম্পর্কে আরও তথ্যের জন্য, [**আমাদের ডকস দেখুন**](https://cybersec.org.za/docs)।

### অবদান (Contributing)

আপনি যদি OpenHack এ অবদান রাখতে চান, অনুগ্রহ করে একটি পুল রিকোয়েস্ট সাবমিট করার আগে আমাদের [কন্ট্রিবিউটিং ডকস](./CONTRIBUTING.md) পড়ে নিন।

### OpenHack এর উপর বিল্ডিং (Building on OpenHack)

আপনি যদি এমন প্রজেক্টে কাজ করেন যা OpenHack এর সাথে সম্পর্কিত এবং প্রজেক্টের নামের অংশ হিসেবে "openhack" ব্যবহার করেন, উদাহরণস্বরূপ "openhack-dashboard" বা "openhack-mobile", তবে দয়া করে আপনার README তে একটি নোট যোগ করে স্পষ্ট করুন যে এই প্রজেক্টটি OpenHack দল দ্বারা তৈরি হয়নি এবং আমাদের সাথে এর কোনো সরাসরি সম্পর্ক নেই।

---

**আমাদের কমিউনিটিতে যুক্ত হোন** [Discord](https://discord.gg/openhack) | [X.com](https://x.com/openhack)
