...
- PR #10018: https://github.com/anomalyco/openhack/pull/10018
- PR #12935: https://github.com/anomalyco/openhack/pull/12935

## Do Not Translate (Locale Additions)

- `OpenHack` (preserve casing in prose; keep `openhack` only in commands, package names, paths, or code)
- `OpenHack CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
