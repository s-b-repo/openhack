...
- PR #15835: https://github.com/anomalyco/openhack/pull/15835

## Do Not Translate (Locale Additions)

- `OpenHack` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `openhack` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `OpenHack` in prose, `openhack` only for exact technical identifiers
...
- Avoid changing `openhack` to `OpenHack` inside commands, URLs, package names, or code literals
