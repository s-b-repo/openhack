...
Use this folder for locale-specific translation guidance that supplements `.openhack/agent/translator.md`.
...
- PR #12345: https://github.com/anomalyco/openhack/pull/12345

## Do Not Translate (Locale Additions)

- `OpenHack` (preserve casing)
