...
- PR #13942: https://github.com/anomalyco/openhack/pull/13942

## Do Not Translate (Locale Additions)

- `OpenHack` (preserve casing in prose; keep `openhack` only when it is part of commands, package names, paths, or code)
- `OpenHack Zen`
- `OpenHack CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `openhack` in prose when referring to the product name; use `OpenHack`
