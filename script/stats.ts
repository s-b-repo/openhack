...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/anomalyco/openhack/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for anomalyco/openhack...\n")
...
console.log("Fetching npm all-time downloads for openhack-ai...\n")
const npmDownloads = await fetchNpmDownloads("openhack-ai")
