...
Generates UPCOMING_CHANGELOG.md by running the openhack changelog command.

Options:
  -f, --from <version>   Starting version (default: latest non-draft GitHub release)
  -t, --to <ref>         Ending ref (default: HEAD)
      --variant <name>   Thinking variant for openhack run (default: low)
      --quiet            Suppress openhack command output unless it fails
